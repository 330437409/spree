      ...
      module Admin
        class StoreSerializer < V3::BaseSerializer
          typelize name: :string, url: :string, code: :string, api_url: :string,
                   ...
                   preferred_reverse_geocode_provider: [:string, nullable: true],
                   preferred_reverse_geocode_fallback_provider: [:string, nullable: true],
                   preferred_reverse_geocode_tencent_key: [:string, nullable: true],
                   preferred_reverse_geocode_ttl_days: [:number, nullable: true],
                   preferred_tencent_maps_js_key: [:string, nullable: true],
