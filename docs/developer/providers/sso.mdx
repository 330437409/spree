...
For the providers a shopper signs in with directly — WeChat, Douyin and Google — see [social login](/integrations/authentication/social-login). It uses the same strategy registry and links accounts by an address the provider marked verified.
